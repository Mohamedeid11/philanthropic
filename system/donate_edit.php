...
if (isset($_POST['donate_update'])) {
    ...
    if (!empty($errors)) {
        ...
        if (isset($_FILES['image_update']['name']) && $_FILES['image_update']['name'] != '') {
            ...
            $target_dir = "api/uploads/donates/" . $id;
...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"> <?php echo trans('donates'); ?> </h4>
                <ol class="breadcrumb">
                    <li>
                        <a href="donate_view.php?lang=<?php echo $lang; ?>"><?php echo trans('donates'); ?>  </a>
                    </li>
                    <li class="active">
                        <?php echo trans('edit_donate'); ?>
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        if ($row_select) {
                            ...
                            <form method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" value="<?php echo $price; ?>" name="price" required class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="text-center p-20">
                                            ...
                                            <button type="submit" name="donate_update" class="btn w-sm btn-default waves-effect waves-light"><?php echo trans('update'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
