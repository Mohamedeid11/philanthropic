...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            ...
            $data_num = $common_questionObj->count($_GET);
            $allData = $common_questionObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "common_questions_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="common_questions_details.php?common_question_id=<?= $id; ?>" class="on-default"><i class="fa fa-eye"></i></a>

                                        <a href="common_questions_edit.php?common_question_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
