    ...
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="founders_view.php"><?php echo trans('founders'); ?></a>
                    </li>
                    <li class="active">
            ...
            $data_num = $founderObj->count($_GET);
            $allData = $founderObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "founders_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!--                                        <a href="founders_details.php?founder_id=--><?//= $id; ?><!--" class="on-default"><i class="fa fa-eye"></i></a>-->

                                        <a href="founders_edit.php?founder_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
