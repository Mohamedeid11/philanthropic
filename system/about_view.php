...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            ...
            $start = ($page - 1) * $items;
            $aboutObj = new About();
            $data_num = $aboutObj->count($_GET);
            $allData = $aboutObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "about_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="about_edit.php?about_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
