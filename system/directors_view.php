...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><?php echo trans('directors'); ?></h4>
                <ol class="breadcrumb">
                    <li>
                        <a href="directors_view.php"><?php echo trans('directors'); ?></a>
                    </li>
                    <li class="active">
            ...
            $data_num = $directorObj->count($_GET);
            $allData = $directorObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "directors_view.php?items=" . $items;
                    ...
                    <div class="row">
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            <tr>
                                ...
                                <th><?php echo trans('position_ar'); ?></th>
                                <th><?php echo trans('position_en'); ?></th>
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $position_ar; ?></td>
                                    <td><?php echo $position_en; ?></td>
                                    ...
                                    <td>
<!--                                        <a href="directors_details.php?director_id=--><?//= $id; ?><!--" class="on-default"><i class="fa fa-eye"></i></a>-->

                                        <a href="directors_edit.php?director_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
