    ...
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="donate_view.php"><?php echo trans('donates'); ?></a>
                    </li>
                    <li class="active">
            ...
            $data_num = $donateObj->count($_GET);
            $allData = $donateObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "donate_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="donate_details.php?donate_id=<?= $id; ?>" class="on-default"><i class="fa fa-eye"></i></a>

                                        <a href="donate_edit.php?donate_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
