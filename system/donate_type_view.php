...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><?php echo trans('donate_type'); ?></h4>
                <ol class="breadcrumb">
                    <li>
                        <a href="donate_type_view.php"><?php echo trans('donate_type'); ?></a>
                    </li>
                    <li class="active">
            ...
            $data_num = $donate_typeObj->count($_GET);
            $allData = $donate_typeObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "donate_type_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
<!--                                        <a href="donate_type_edit.php?donate_type_id=--><?php //echo $id; ?><!--" class="on-default"><i class="fa fa-pencil"></i></a>-->
