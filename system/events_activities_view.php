    ...
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="events_activities_view.php"><?php echo trans('events_activities'); ?></a>
                    </li>
                    <li class="active">
            ...
            $data_num = $event_activityObj->count($_GET);
            $allData = $event_activityObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "events_activities_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="events_activities_details.php?event_activity_id=<?= $id; ?>" class="on-default"><i class="fa fa-eye"></i></a>

                                        <a href="events_activities_edit.php?event_activity_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
