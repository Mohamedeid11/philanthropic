...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><?php echo trans('news'); ?></h4>
                <ol class="breadcrumb">
                    <li>
                        <a href="news_view.php"><?php echo trans('news'); ?></a>
                    </li>
                    <li class="active">
            ...
            $start = ($page - 1) * $items;
            $newsObj = new News();
            $data_num = $newsObj->count($_GET);
            $allData = $newsObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "news_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="news_details.php?news_id=<?= $id; ?>" class="on-default"><i class="fa fa-eye"></i></a>

                                        <a href="news_edit.php?news_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
