...
if (isset($_POST['news_update'])) {
    ...
    if (!empty($errors)) {
        ...
        if (isset($_FILES['image_update']['name']) && $_FILES['image_update']['name'] != '') {
            ...
            $target_dir = "api/uploads/news/" . $id;
    ...
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="news_view.php?lang=<?php echo $lang; ?>"><?php echo trans('news'); ?>  </a>
                    </li>
                    <li class="active">
                        <?php echo trans('edit_news'); ?>
                    </li>
                </ol>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="text-center p-20">
                                            ...
                                            <button type="submit" name="news_update" class="btn w-sm btn-default waves-effect waves-light"><?php echo trans('update'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
