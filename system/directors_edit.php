...
if (isset($_POST['director_update'])) {
    ...
    $director = $directorObj->getById($id);
    ...
    if (!empty($errors)) {
        ...
        if (isset($_FILES['image_update']['name']) && $_FILES['image_update']['name'] != '') {
            ...
            $target_dir = "api/uploads/directors/" . $id;
            ...
            if ($director['image']) {
                $name = strstr($director['image'], 'api/');
                if (is_file($name)) {
                    unlink($name);
                }
            }
    ...
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="directors_view.php?lang=<?php echo $lang; ?>"><?php echo trans('directors'); ?>  </a>
                    </li>
                    <li class="active">
                        <?php echo trans('edit_director'); ?>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    if (isset($_GET['director_id'])) {
                        $row_select = $directorObj->getById($_GET['director_id']);
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="text-center p-20">
                                            ...
                                            <button type="submit" name="director_update" class="btn w-sm btn-default waves-effect waves-light"><?php echo trans('update'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
