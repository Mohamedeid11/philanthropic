...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            ...
            $data_num = $sliderObj->count($_GET);
            $allData = $sliderObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "slider_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="slider_edit.php?slider_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                        <a href="javascript:;" data-id="<?php echo $id; ?>" data-image="<?php echo $image; ?>" data-background="<?php echo $background_image; ?>" class="deletemsg" ><i class="fa fa-trash-o"></i></a>
                                    </td>
