...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            ...
            $data_num = $magazineObj->count($_GET);
            $allData = $magazineObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "magazine_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="magazine_edit.php?magazine_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
