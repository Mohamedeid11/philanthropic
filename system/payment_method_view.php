...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><?php echo trans('payment_method'); ?></h4>
                <ol class="breadcrumb">
                    <li>
                        <a href="payment_method_view.php"><?php echo trans('payment_method'); ?></a>
                    </li>
                    <li class="active">
            ...
            $data_num = $payment_methodObj->count($_GET);
            $allData = $payment_methodObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "payment_method_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!--                                        <a href="payment_method_edit.php?payment_method_id=--><?php //echo $id; ?><!--" class="on-default"><i class="fa fa-pencil"></i></a>-->
