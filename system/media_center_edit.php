...
if (isset($_POST['media_center_update'])) {
    ...
    $media_center = $media_centerObj->getById($id);
    ...
    if (!empty($errors)) {
        ...
        if (isset($_FILES['image_update']['name']) && $_FILES['image_update']['name'] != '') {
            ...
            if ($media_center['image']) {
                $name = strstr($media_center['image'], 'api/');
                if (is_file($name)) {
                    unlink($name);
                }
            }
    ...
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="media_center_view.php?lang=<?php echo $lang; ?>"><?php echo trans('media_center'); ?>  </a>
                    </li>
                    <li class="active">
                        <?php echo trans('edit_media_center'); ?>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    if (isset($_GET['media_center_id'])) {
                        $row_select = $media_centerObj->getById($_GET['media_center_id']);
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="text-center p-20">
                                            ...
                                            <button type="submit" name="media_center_update" class="btn w-sm btn-default waves-effect waves-light"><?php echo trans('update'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
