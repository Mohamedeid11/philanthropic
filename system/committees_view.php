...
<div class="wrapper">
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            ...
            $data_num = $committeeObj->count($_GET);
            $allData = $committeeObj->getAll($start, $items, $_GET);  //echo '<pre>'; print_r($allData); die();
            $url = "committees_view.php?items=" . $items;
                        ...
                        <table  class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                            ...
                            foreach ($allData as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="committees_details.php?committee_id=<?= $id; ?>" class="on-default"><i class="fa fa-eye"></i></a>

                                        <a href="committees_edit.php?committee_id=<?php echo $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
