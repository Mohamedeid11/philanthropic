    ...
    <div class="container">    <!-- Start content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="about_view.php?lang=<?php echo $lang; ?>"><?php echo trans('about'); ?>  </a>
                    </li>
                    <li class="active">
                        <?php echo trans('edit_about'); ?>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    if (isset($_GET['about_id'])) {
                        $row_select = $aboutObj->getById($_GET['about_id']);
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="text-center p-20">
                                            ...
                                            <button type="submit" name="about_update" class="btn w-sm btn-default waves-effect waves-light"><?php echo trans('update'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
